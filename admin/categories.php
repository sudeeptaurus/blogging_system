...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($category != "") {
        ...
        $msg = "<div class='alert alert-danger'>This field is needed</div>";
    }
}
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="col-sm-6">
                        ...
                        <?php if ($category_obj->loadCategories()) : ?>
                            <table class="table table-hover table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($category_obj->loadCategories() as $category) :
                                        $id = $category->id;
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $id; ?></td>
                                            <td><?php echo $cat; ?></td>
                                            <td><a href="?delete_cat=<?php echo $cat; ?>" class="btn btn-danger">Delete</a></td>
                                        </tr>
                        ...
                        <?php else : ?>
                            <h2 class='text-center'>No Category added yet!</h2>
                        <?php endif; ?>
